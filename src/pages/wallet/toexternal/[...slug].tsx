...
const ToExternal = () =>{
    ...
    useEffect(()=>{
        if(router.isReady){
            ...
            const fetchUserBounty = async () => {
                ...
                const data= await axios.get("http://101.32.184.176:7001/api/near/query/near_account_balance",{
                    params:{
                        near_address
                    }
                })
    ...
    const confirm =async ()=>{
        ...
        await axios.post("http://101.32.184.176:7001/api/near/user/transfer/near",{
